...
keywords = ['abuse', 'academic', 'autobiography', 'action', 'adult-fiction', 'animals', 'art', 
            'biography', 'business', 'chick-lit', 'childrens', 'christian', 'classics', 'comedy', 
            'comics', 'contemporary', 'crime', 'bdsm', 'cookbooks', 'dark', 'death', 'detective', 
            'drama', 'dystopia', 'economics', 'epic', 'erotica', 'family' ,'fantasy', 'feminism', 
            'gay-and-lesbian', 'graphic-novels', 'ghosts', 'gothic', 'juvenile', 'inspirational', 
            'historical-fiction', 'history', 'horror', 'humor', 'love', 'manga', 'memoir', 'music', 
            'mystery', 'mythology', 'nature', 'paranormal', 'philosophy', 'poetry', 'psychology', 
            'religion', 'romance', 'science', 'science-fiction', 'self-help', 'suspense', 
            'spirituality', 'sports', 'teen', 'time-travel', 'thriller', 'travel', 
            'young-adult', 'urban-fantasy', 'vampires', 'war','womens-fiction']

def parse_html_page(link, publication_year, publisher, num_pages, image_url):
...
def get_book_info(book_id, genre):
    ...
    if work['best_book_id']['#text'] == book_id:
        work_dict_fields = ['ratings_sum', 'ratings_count', 'original_publication_year']
...
start_year = 2011
end_year = 2017
with open('data/fiction_goodreads-ids.csv', newline='') as f:
    data = []
