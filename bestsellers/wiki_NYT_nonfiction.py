...
base_url = "https://en.wikipedia.org/wiki/The_New_York_Times_Non-Fiction_Best_Sellers_of_{}"
...
with open('wiki_NYT_nonfiction.csv', mode='at', encoding='utf-8') as f:
    # other lesser options ; text, json
    #f.write('\n'.join(tops))
    #json.dump(tops, f)   
    writer = csv.writer(f)
